...
## Ecart-type des rendements du portefeuille

```{r cars9, cache=TRUE, eval=TRUE, dpi=100, echo=FALSE, cache.comments=FALSE, warning=FALSE, fig.align="center"}
...
cat("VaR 99%, de toute les simulations: ", round(var99_predict,digits = 2))
...
cat("Volatilité maximale observée , de toute les simulations: ", vola_proj_max)

cat("Volatilité moyenne observée , de toute les simulations: ", mean(vola_proj_max))
...
cat("VaR de toutes simulations: ",round(var99_predict2,digits = 2))
...
```{r cars18, cache=TRUE, eval=TRUE, dpi=100, echo=FALSE, cache.comments=FALSE, warning=FALSE, fig.align="center"}
############ Grphique des rendement projetés
